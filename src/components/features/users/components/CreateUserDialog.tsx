...
export function CreateUserDialog({
  ...
  // MODERATOR can only create AGENT; derive displayed role so we don't setState in effect
  const effectiveRole = open && user?.role === 'MODERATOR' ? 'AGENT' : role;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      role: effectiveRole || defaultRole,
      isActive: true,
    });
  };
